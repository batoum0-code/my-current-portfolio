...
const DarkMagicButton = ({ text, size, bg, hoverBg, rounded, color, hoverColor }) => {
    ...
    return (
        ...
        >
            ...
            {/* Blue background */}
            <motion.span
                className={`absolute inset-0 ${hoverBg ? `bg-${hoverBg}`: 'bg-deepb'} rounded-[30rem] scale-150 z-0 border-[1px] border-gray `}
                style={{
...
export default DarkMagicButton;
